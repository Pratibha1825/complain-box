...
if($conn)
{
	...
	$result=mysqli_query($conn,$query1) or die("query failed first");
	if($result)
	{
	...
	$query2="SELECT * FROM `userregistration`";
	$result=mysqli_query($conn,$query2)or die("query failed second");
	if($result)
	{
